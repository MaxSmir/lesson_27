...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pGround->LoadMesh("C:/Users/sofya/source/repos/lr5 IikG/lesson 27/Content/quad.obj")) {
            return false;
        }

        if (!m_billboardList.Init("C:/Users/sofya/source/repos/lr5 IikG/lesson 27/Content/monster_hellknight.png")) {
            return false;
        }

        m_pTexture = new Texture(GL_TEXTURE_2D, "C:/Users/sofya/source/repos/lr5 IikG/lesson 27/Content/bricks.jpg");
        ...
        m_pNormalMap = new Texture(GL_TEXTURE_2D, "C:/Users/sofya/source/repos/lr5 IikG/lesson 27/Content/normal_map.jpg");
